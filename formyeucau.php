...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="index.php">HORUSENT DAILY</a>
    <!-- Sidebar Toggle-->
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h2 class="text-center font-weight-light my-4">Tạo yêu cầu</h2></div>
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="form-floating mb-3">
                                                ...
                                                <label for="inputEmail">Lý do:</label>
                                            </div>
                                            <div class="form-floating mb-3" >
                                                <form><center>
                                                        <p>Thời gian từ:&ensp;
                                                            <input type="datetime-local" id="time" style="width: 232px; height: 40px;"/>
                                                            &ensp;
                                                            đến:&ensp;
                                                            <input type="datetime-local" id="time" style="width: 232px; height: 40px;"/>
                                                        </p>
                                                ...
                                                <form>
                                                    <center>
                                                        <select style="width: 285px;height: 40px;">
                                                            <option selected>Loại yêu cầu</option>
                                                        ...
                                                        <select style="width: 285px;height: 40px;">
                                                            <option selected>Loại nghỉ phép</option>
